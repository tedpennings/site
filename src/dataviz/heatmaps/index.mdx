...
in electoral college heat maps, showing the party leaning of a state as "strongly", "weak",
"tossup", "neutral", and wrapping back to "weak" and "strongly" for the opposite party. This
is just a heatmap with specific intervals/stops.
