import ElectoralCollegeTooltip from './electoral_college_tooltip';
...
in <ElectoralCollegeTooltip>electoral college heat maps</ElectoralCollegeTooltip>,
showing the party leaning of a state as _safe_, _likely_, _leans_, _toss up_, and
wrapping back to _leans_ and _safe_ for the opposite party. This is just a heatmap
with specific intervals/stops.
